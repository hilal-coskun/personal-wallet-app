...
public class UpdateIncomePageActivity extends AppCompatActivity {

    String id, date, subject, amount;
    EditText date_input, subject_input, amount_input;
    Button update_button, delete_income_button;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_income_page);
        ...
        delete_income_button = (Button) findViewById(R.id.delete_income_button);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseHelper db = new DatabaseHelper(UpdateIncomePageActivity.this);
                date = date_input.getText().toString().trim();
                subject = subject_input.getText().toString().trim();
                amount = amount_input.getText().toString().trim();
                db.update(id, date, subject, amount);
            }
        });

        delete_income_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog();
            }
